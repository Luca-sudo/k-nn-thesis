...
lsh_mean_r = lsh_only_r.groupby(['LID', 'Kappa']).agg(MeanRecall=('Recall', 'mean')).reset_index().pivot(index='LID', columns='Kappa', values='MeanRecall')
hnsw_mean_r = hnsw_only_r.groupby(['LID', 'Kappa']).agg(MeanRecall=('Recall', 'mean')).reset_index().pivot(index='LID', columns='Kappa', values='MeanRecall')
...
lsh_mean_r = lsh_mean_r.reset_index().melt(id_vars=['LID'], var_name='Kappa', value_name='MeanRecall')
hnsw_mean_r = hnsw_mean_r.reset_index().melt(id_vars=['LID'], var_name='Kappa', value_name='MeanRecall')

sns.lineplot(hnsw_mean_r, x='Kappa', y='MeanRecall', hue='LID')
#plt.show()
