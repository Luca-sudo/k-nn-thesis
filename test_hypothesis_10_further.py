...
timings.to_hdf(target_path + "_further_results.h5", key="timings", format="table")
qualities.to_hdf(target_path + "_further_results.h5", key="qualities", format="table")
ranks.to_hdf(target_path + "_further_results.h5", key="ranks", format="table")
recalls.to_hdf(target_path + "_further_results.h5", key="recalls", format="table")

results = h5py.File(target_path + "_further_results.h5", 'r+')
