...
sns.lineplot(data=qualities[(qualities['algo'] == 'lsh') | (qualities['algo'] == 'rand sampling')], x='instance', y='Quality', hue='algo', palette=algo_to_color, legend=False)
...
plt.savefig(plot_path + "_qualities_lsh_and_sampling.pdf")
...
sns.lineplot(data=recalls[(recalls['algo'] == 'lsh') | (recalls['algo'] == 'rand sampling')], x='k', y='Recall', hue='algo', palette=algo_to_color, legend=False)

plt.savefig(plot_path + "_recalls@_lsh_and_sampling.pdf")
